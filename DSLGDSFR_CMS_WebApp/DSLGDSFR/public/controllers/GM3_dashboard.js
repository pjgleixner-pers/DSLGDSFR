...
document.addEventListener('DOMContentLoaded', function(){
    ...
    genericRef.orderByChild('Grupo').equalTo(23).on("value", function(snapshot){
        var c = 0;
...
function toedit(pathid){
    ...
    window.location = "https://dslgdsfr.web.app/GM3_editar.html";
}
...
function todelete(pathid2){
    ...
    if (result) {
        ...
        window.location = "https://dslgdsfr.web.app/GM3_dashboard.html";
    }
...
agregarBtn.addEventListener('click', (e) => {
    e.preventDefault();
    window.location = "https://dslgdsfr.web.app/GM3_agregar.html";
});