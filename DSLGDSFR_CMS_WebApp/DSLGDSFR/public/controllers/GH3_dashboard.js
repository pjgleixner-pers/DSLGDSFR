...
document.addEventListener('DOMContentLoaded', function(){
    ...
    genericRef.orderByChild('Grupo').equalTo(13).on("value", function(snapshot){
        var c = 0;
...
function toedit(pathid){
    ...
    window.location = "https://dslgdsfr.web.app/GH3_editar.html";
}
...
function todelete(pathid2){
    ...
    if (result) {
        ...
        window.location = "https://dslgdsfr.web.app/GH3_dashboard.html";
    }
...
agregarBtn.addEventListener('click', (e) => {
    e.preventDefault();
    window.location = "https://dslgdsfr.web.app/GH3_agregar.html";
});